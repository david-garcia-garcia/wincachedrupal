...
/**
 * @file
 * Contains \Drupal\wincachedrupal\KeyValueStorage\KeyValueWincacheExpirableFactory.
 */
...
class KeyValueWincacheExpirableFactory implements KeyValueExpirableFactoryInterface {
  ...
  public function get($collection) {
    if (!isset($this->storages[$collection])) {
      $this->storages[$collection] = new WincacheStorageExpirable($collection, $this->serializer, $this->connection);
    }
